...
# write name of duplicate files from that directory into log file named as Log.txt. Log.txt file should be 
# created into current diectory. Display execution time required for the script.
